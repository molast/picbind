...
`docs/prd/collaboration/COMPRESSION_ALGORITHM.md`。
...
当前实现位于 `desktop/src-tauri/src/storage/`，使用应用内单连接 `rusqlite`，通过互斥锁
串行访问。已注册的命令为：
