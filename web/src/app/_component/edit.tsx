    ...
    >
      ...
      <div className="hidden md:block left w-[310px] h-full shadow-2xl">
        <div className="sider-bar w-[310px] h-full p-4 bg-white flex flex-col">
          ...
          <div
            className={twMerge(
              "w-full pt-4 bg-white",
              status === "Pending" ? "pointer-events-none opacity-60" : "",
            )}
          >
          ...
          <div className="flex space-x-4 items-center">
            ...
            {["create-video"].includes(tool.name) && (
              <Button
                ...
                variant="default"
                size={"sm"}
                onClick={() => SystemManager.downloadVideo(videoSrc)}
              >
                <RiDownload2Fill />
                <span>{Locale.System.Download}</span>
              </Button>
            ...
            {["read-text"].includes(tool.name) && (
              <MdModal
                trigger={readRef}
                content={textContent}
                confirm={() => SystemManager.copyToClipboard(textContent)}
              />
            )}
