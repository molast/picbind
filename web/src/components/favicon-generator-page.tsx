    ...
    <main className="w-full bg-[#efefef] text-[#1f2328]">
      <section className="bg-[#08090c] px-5 pb-20 pt-16 text-white sm:px-8 lg:px-12">
        <div className="mx-auto w-full max-w-[1200px]">
          <h1 className="max-w-[720px] text-4xl font-extrabold leading-[1.15] tracking-[0.01em] sm:text-5xl">
            Favicon Generator / Generate from Image
          </h1>
          <p className="mt-5 max-w-[760px] text-xl text-white/70">
      ...
      <section className="mx-auto mt-[-52px] w-full max-w-[1240px] px-5 pb-8 sm:px-8 lg:px-12">
        <div className="rounded-xl border border-[#dfdfdf] bg-white p-6 shadow-[0_10px_30px_rgba(11,12,15,0.06)]">
          <h2 className="text-5xl font-bold leading-none tracking-[-0.02em] text-[#24292f]">Converter</h2>
          <div
          ...
          >
            <p className="cursor-pointer text-[27px] text-[#57606a]">
          ...
          <div className="mt-5 flex flex-wrap items-center gap-4">
            <button
              ...
              className="inline-flex items-center rounded-full bg-[#3a98f6] px-8 py-3 text-2xl font-semibold text-white transition hover:bg-[#2b89e8] disabled:cursor-not-allowed disabled:bg-[#9fc7ee]"
            >
            ...
            {error ? <p className="text-base text-[#cf222e]">{error}</p> : null}
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto w-full max-w-[1240px] px-5 pb-8 sm:px-8 lg:px-12">
        <div className="rounded-xl border border-[#dfdfdf] bg-white p-6 shadow-[0_10px_30px_rgba(11,12,15,0.04)]">
          <h3 className="text-4xl font-bold text-[#24292f]">Installation</h3>
          <p className="mt-4 text-[30px] leading-[1.5] text-[#57606a]">
            First, use the download button to download the files listed below. Place the files in
            the root directory of your website.
          </p>
          <ul className="mt-4 list-disc space-y-2 pl-7 text-[34px] text-[#4f5660]">
            {installFiles.map((item) => (
              <li key={item}>{item}</li>
            ))}
          </ul>

          <p className="mt-6 text-[30px] leading-[1.5] text-[#57606a]">
          ...
          <pre className="mt-4 overflow-auto rounded bg-[#f6f8fa] p-4 text-[26px] leading-[1.55] text-[#3d444d]">
          ...
          <button
            type="button"
            onClick={onCopyHtml}
            className="mt-4 rounded-md bg-[#3a98f6] px-5 py-2 text-lg font-semibold text-white transition hover:bg-[#2b89e8]"
          >
            Copy
          </button>
        </div>
      ...
      <section className="mx-auto w-full max-w-[1240px] px-5 pb-16 sm:px-8 lg:px-12">
        <div className="rounded-xl border border-[#dfdfdf] bg-white p-6 shadow-[0_10px_30px_rgba(11,12,15,0.04)]">
          <h3 className="text-4xl font-bold text-[#24292f]">About the favicon generator</h3>
          <p className="mt-4 text-[30px] leading-[1.55] text-[#57606a]">
          ...
          <h4 className="mt-6 text-4xl font-bold text-[#24292f]">Why do I need an ICO file instead of a PNG?</h4>
          <p className="mt-4 text-[30px] leading-[1.55] text-[#57606a]">
          ...
          <h4 className="mt-6 text-4xl font-bold text-[#24292f]">
