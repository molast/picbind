...
import { FiCheck, FiImage, FiLoader, FiX, FiZap } from "react-icons/fi";
import {
              ...
              {items.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`flex w-full items-center gap-3 p-3 text-left transition ${isSelected ? "bg-blue-50" : "hover:bg-slate-50"}`}
                  >
