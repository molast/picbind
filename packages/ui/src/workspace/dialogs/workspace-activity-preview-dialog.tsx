...
import { ImageAddressMedia } from "../components/workspace-image-media";
...
type ActivityPreview = { activity: WorkspaceActivity; parameterDocument: { operations: unknown[] }; previewUrl: string };
