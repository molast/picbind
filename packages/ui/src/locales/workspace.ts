...
const zh: WorkspaceLabels = {
  ...
  leaveWorkspace: "退出工作区", leaveWorkspaceQuestion: "退出这个工作区？", leaveWorkspaceDescription: "退出后将断开当前协作连接。从首页进入 Image Workspace 会返回你自己的工作区。", cancel: "取消", close: "关闭", confirm: "确认", save: "保存", sourceFileSize: "源文件", downloading: "正在下载...", downloadComplete: "下载完成", accept: "接受", reject: "拒绝", preview: "预览", approve: "同意", later: "稍后处理", removeCollaborator: "移除协作者", removedFromWorkspace: "已被移出工作区", removedFromWorkspaceDescription: "Owner 已将你移出此工作区，当前协作连接已关闭。",
