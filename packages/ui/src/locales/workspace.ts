...
const en: WorkspaceLabels = {
  ...
  leaveWorkspaceDescription: "Leaving disconnects the current collaboration session and returns to the home page.", ownerLeaveWorkspaceQuestion: "What would you like to do with this Workspace?", exitWorkspace: "Exit workspace", exitWorkspaceDescription: "Exit this workspace and close this page. Your Workspace data remains available next time you open it.", temporarilyLeaveWorkspace: "Suspend workspace", temporarilyLeaveWorkspaceDescription: "Keep this Workspace open in the background so you can resume it later.", workspaceSuspended: "Workspace suspended", resumeWorkspace: "Resume workspace", rememberWorkspaceLeaveChoice: "Remember this choice", workspaceSettingsStyle: "Style", workspaceSettingsBehavior: "Behavior", workspaceSettingsMessaging: "Messaging", workspaceLeavePreference: "When leaving as Owner", workspaceLeavePreferenceAsk: "Ask every time", workspaceLeavePreferenceSuspend: "Suspend workspace", workspaceLeavePreferenceExit: "Exit workspace",
...
const zh: WorkspaceLabels = {
  ...
  leaveWorkspace: "退出工作区", leaveWorkspaceQuestion: "退出这个工作区？", leaveWorkspaceDescription: "退出后将断开当前协作连接并返回首页。", ownerLeaveWorkspaceQuestion: "你想如何处理这个工作区？", exitWorkspace: "退出工作区", exitWorkspaceDescription: "退出并关闭当前工作区页面。工作区数据会保留，下次打开仍可继续使用。", temporarilyLeaveWorkspace: "暂离工作区", temporarilyLeaveWorkspaceDescription: "将工作区挂起到后台，之后可以恢复。", workspaceSuspended: "工作区已挂起", resumeWorkspace: "恢复工作区", rememberWorkspaceLeaveChoice: "记住这次选择", workspaceSettingsStyle: "样式", workspaceSettingsBehavior: "行为", workspaceSettingsMessaging: "消息", workspaceLeavePreference: "Owner 离开时", workspaceLeavePreferenceAsk: "每次询问", workspaceLeavePreferenceSuspend: "直接暂离工作区", workspaceLeavePreferenceExit: "直接退出工作区", cancel: "取消", close: "关闭", confirm: "确认", save: "保存", sourceFileSize: "源文件", downloading: "正在下载...", downloadComplete: "下载完成", accept: "接受", reject: "拒绝", preview: "预览", approve: "同意", later: "稍后处理", removeCollaborator: "移除协作者", removeCollaboratorQuestion: "移除这个协作者？", removeCollaboratorDescription: "将断开 {name} 与此工作区的连接。", confirmRemoveCollaborator: "移除", removedFromWorkspace: "已被移出工作区", removedFromWorkspaceDescription: "Owner 已将你移出此工作区，当前协作连接已断开。返回首页后可继续使用本地功能。",
