...
const en: WorkspaceLabels = {
  ...
  createShareLink: "Create share link", createNewLink: "Create new link", copyShareLink: "Copy share link", copyWorkspaceId: "Copy Share ID", workspaceIdCopied: "Share ID copied", ownerOffline: "Owner is offline.", loadingWorkspace: "Loading workspace", shareLinkUnavailable: "The share link is invalid or no longer active.", showingCachedWorkspace: "Showing cached workspace data.", noCachedWorkspace: "No cached workspace data is available.",
...
const zh: WorkspaceLabels = {
  ...
  workingEmpty: "处理区为空", addFromOrigin: "从原始图区域添加图片开始处理。", collaboration: "协作", collaborators: "协作者", noCollaborators: "暂无在线协作者", viewingWorkspace: "正在查看",
  ...
  workspaceOverview: "工作区概览", imagesTotal: "图片总数", inWorking: "Working 中", workspaceShare: "工作区分享", createPermanentLink: "创建供协作者使用的永久链接。创建新链接会使旧链接失效。", createShareLink: "创建分享链接", createNewLink: "创建新链接", copyShareLink: "复制分享链接", copyWorkspaceId: "复制 Share ID", workspaceIdCopied: "Share ID 已复制", ownerOffline: "Owner 已离线。", loadingWorkspace: "正在加载工作区", workspaceUnavailable: "工作区不可用", openMyWorkspace: "打开我的工作区", shareLinkUnavailable: "分享链接无效或已失效。", showingCachedWorkspace: "正在显示缓存的工作区数据。", noCachedWorkspace: "没有可用的缓存工作区数据。",
