...
export type WorkspaceLabels = {
  ...
  localStatus: string; connectingStatus: string; connectedStatus: string; syncingStatus: string; availableStatus: string; ownerOfflineStatus: string; unavailableStatus: string; history: string; currentVersion: string; initialVersion: string; version: string; collaborationDeleteBlocked: string; collaborationOnlyOne: string; proposalStale: string; joinedPermanentLink: string; proposalPreview: string; parameterResult: string; currentStep: string; rollbackToStep: string; parameterActions: string;
 };
...
const en: WorkspaceLabels = {
  ...
  collaboration: "Collaboration", collaborators: "Collaborators", noCollaborators: "No collaborators connected", viewingWorkspace: "Viewing workspace",
...
const zh: WorkspaceLabels = {
  ...
  originLibrary: "原始图 · 图片库", chooseOriginal: "选择原图，然后加入 Working", chooseOrDropOriginals: "选择或拖入原图", workingProcessing: "Working · 处理中", processCollaborate: "处理、涂鸦并协作处理选中的图片",
  workingEmpty: "Working 为空", addFromOrigin: "从原始图区域添加图片开始处理。", collaboration: "协作", collaborators: "协作者", noCollaborators: "暂无在线协作者", viewingWorkspace: "正在查看工作区",
