...
const en: WorkspaceLabels = {
  ...
  stopCollaborationQuestion: "Stop collaboration?", stopCollaborationDescription: "Stop restores this Working card to its original cached thumbnail. Save & stop lets you overwrite it with the rendered result or create a new image first.", stoppingCollaboration: "Stopping...", stopDirectly: "Stop", saveAndStopCollaboration: "Save & stop", saveImageQuestion: "Save current image?", saveImageConfirmationDescription: "Choose whether to overwrite this image or create a new rendered image in Working.",
...
const zh: WorkspaceLabels = {
  stopCollaborationQuestion: "停止图片协作？", stopCollaborationDescription: "直接停止会让当前 Working 卡片恢复原始缩略图缓存；保存并停止可先覆盖当前图片或另存为新图片。", stoppingCollaboration: "正在处理...", stopDirectly: "停止", saveAndStopCollaboration: "保存并停止", saveImageQuestion: "保存当前图片？", saveImageConfirmationDescription: "选择覆盖当前图片，或者在 Working 中创建一张新的渲染图片。",
