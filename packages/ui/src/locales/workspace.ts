...
const zh: WorkspaceLabels = {
  ...
  workspaceOverview: "工作区概览", imagesTotal: "图片总数", inWorking: "Working 中", workspaceShare: "工作区分享", createPermanentLink: "创建供协作者使用的永久链接。创建新链接会使旧链接失效。", createShareLink: "创建分享链接", createNewLink: "创建新链接", copyShareLink: "复制分享链接", shareLinkCopied: "分享链接复制成功", copyWorkspaceId: "复制分享 ID", workspaceIdCopied: "分享 ID 复制成功", shareId: "分享 ID", enterWorkspace: "进入工作区", join: "加入", ownerOffline: "Owner 已离线。", loadingWorkspace: "正在加载工作区", workspaceUnavailable: "工作区不可用", openMyWorkspace: "打开我的工作区", shareLinkUnavailable: "分享链接无效或已失效。", showingCachedWorkspace: "正在显示缓存的工作区数据。", noCachedWorkspace: "没有可用的缓存工作区数据。",
