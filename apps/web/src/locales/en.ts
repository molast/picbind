...
const en: LocaleType = {
  ...
  HomeCompressLanding: {
    ...
    desktop: {
      ...
      subtitle: "Choose images and PicBind will process them on this device",
      compress: "Compress",
      favicon: "Favicon",
      workspace: "Workspace",
      ...
      resultCount: (images: number, outputs: number) => `${images} image${images === 1 ? "" : "s"} · ${outputs} output${outputs === 1 ? "" : "s"}`,
